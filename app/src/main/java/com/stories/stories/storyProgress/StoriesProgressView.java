package com.stories.stories.storyProgress;
...
public class StoriesProgressView extends LinearLayout {
    ...
    private final LayoutParams SPACE_LAYOUT_PARAM = new LayoutParams(10, LayoutParams.WRAP_CONTENT);
...
//        typedArray.recycle();
    ...
    public boolean hasStarted(){
        if(current < 0)
            return false;
        return progressBars.get(0).hasStarted();
    }
}
